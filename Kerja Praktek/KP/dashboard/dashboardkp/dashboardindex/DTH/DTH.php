    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
           <center><img alt="Telkom Indonesia" src="../img/LOGO.png" height="90" width="150"  /></center>
            <br>
            <li><a href="../3P/3P.php" ><center>BACK</center></a></li>
            <br>
            <li ><h5><center>add LIS INDIHOME 3P</center></h5></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="CONTAINER">
            <div class="col-sm-9">
                <button onClick="window.location=' http://localhost/TUGAS/KP/dashboard/dashboardkp/dashboardindex/DTH/DTH.php'" style="-moz-box-shadow:inset 0px 1px 0px 0px #f29c93;
