    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
           <center><img alt="Telkom Indonesia" src="../img/LOGO.png" height="90" width="150"  /></center>
            <br>
            <li><a href="../index.php" ><center>DASHBOARD</center></a></li>
            <br>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="CONTAINER">
            <div class="col-sm-9">
                <button onClick="window.location='http://localhost/KP/dashboard/dashboardkp/dashboardindex/Version2/Data_PI/final1.php'" style="-moz-box-shadow:inset 0px 1px 0px 0px #f29c93;
...
&nbsp; &nbsp;
                 ...
                 <button onClick="window.location='http://localhost/KP/dashboard/dashboardkp/dashboardindex/PS/PS.php'" style="-moz-box-shadow:inset 0px 1px 0px 0px #f29c93;
  -webkit-box-shadow:inset 0px 1px 0px 0px #f29c93;
  box-shadow:inset 0px 1px 0px 0px #f29c93;
  background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #c41400), color-stop(1, #cf0606) );
  background:-moz-linear-gradient( center top, #c41400 5%, #cf0606 100% );
