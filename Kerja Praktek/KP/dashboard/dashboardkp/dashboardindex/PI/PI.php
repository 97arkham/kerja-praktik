...
-->
               ...
               <button onClick="window.location='http://localhost/TUGAS/KP/dashboard/dashboardkp/dashboardindex/version2/Data_PI/show/jumlah.php'" style="-moz-box-shadow:inset 0px 1px 0px 0px #f29c93;
  ...
  position:relative;
  top:1px;"><b>JUMLAH PI</b></button>

  &nbsp; &nbsp;


                <button onClick="window.location='http://localhost/TUGAS/KP/dashboard/dashboardkp/dashboardindex/grafik/grafik_pi.php'" style="-moz-box-shadow:inset 0px 1px 0px 0px #f29c93;
  -webkit-box-shadow:inset 0px 1px 0px 0px #f29c93;
  box-shadow:inset 0px 1px 0px 0px #f29c93;
  background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #c41400), color-stop(1, #cf0606) );
  background:-moz-linear-gradient( center top, #c41400 5%, #cf0606 100% );
