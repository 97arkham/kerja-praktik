...
<html lang="en">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="CONTAINER">
            <div class="col-sm-9">
              ...
              <button onClick="window.location='http://localhost/KP/dashboard/dashboardkp/dashboardindex/version2/Data_PS_Harian/final1.php'" style="-moz-box-shadow:inset 0px 1px 0px 0px #f29c93;
  ...
  position:relative;
  top:1px;"><b>PS HARIAN</b></button>


&nbsp; &nbsp;


                <button onClick="window.location='http://localhost/KP/dashboard/dashboardkp/dashboardindex/grafik/grafik.php'" style="-moz-box-shadow:inset 0px 1px 0px 0px #f29c93;
  -webkit-box-shadow:inset 0px 1px 0px 0px #f29c93;
  box-shadow:inset 0px 1px 0px 0px #f29c93;
  background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #c41400), color-stop(1, #cf0606) );
  background:-moz-linear-gradient( center top, #c41400 5%, #cf0606 100% );
  ...
  background-color:#cf0606;
  position:relative;
  top:1px;"><b>GRAFIK PS TAHUNAN</b></button>

  &nbsp; &nbsp;


                 <button onClick="window.location='  http://localhost/KP/dashboard/dashboardkp/dashboardindex/PS/ps_bulanan.php'" style="-moz-box-shadow:inset 0px 1px 0px 0px #f29c93;
  -webkit-box-shadow:inset 0px 1px 0px 0px #f29c93;
  box-shadow:inset 0px 1px 0px 0px #f29c93;
  background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #c41400), color-stop(1, #cf0606) );
  background:-moz-linear-gradient( center top, #c41400 5%, #cf0606 100% );
  ...
  background-color:#cf0606;
  position:relative;
  top:1px;"><b>GRAFIK PS BULANAN</b></button>
...
<!--
  <button onClick="window.location='http://localhost/TUGAS/KP/dashboard/dashboardkp/dashboardindex/PS/PS.php'" style="-moz-box-shadow:inset 0px 1px 0px 0px #f29c93;
  -webkit-box-shadow:inset 0px 1px 0px 0px #f29c93;
  box-shadow:inset 0px 1px 0px 0px #f29c93;
  background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #c41400), color-stop(1, #cf0606) );
  background:-moz-linear-gradient( center top, #c41400 5%, #cf0606 100% );
