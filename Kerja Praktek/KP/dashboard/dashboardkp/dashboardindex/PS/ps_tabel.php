...
-->
                ...
                <button onClick="window.location='http://localhost/KP/dashboard/dashboardkp/dashboardindex/version2/Data_PS_Harian/show/jumlah.php'"  style="-moz-box-shadow:inset 0px 1px 0px 0px #f29c93;
