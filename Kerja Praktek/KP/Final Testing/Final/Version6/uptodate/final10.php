...
function kirim_url() {
  ...
  if ($a!=$b) {
      $jum = $_GET['full'];
      header("location:http://localhost/KP/Final%20Testing/Final/Version6/uptodate/final231.php?la=$a&ba=$b&cips=cinta&caps=ituindah&full=$jum");
    ...
    header("location:http://localhost/KP/Final%20Testing/Final/Version6/uptodate/final231.php?la=$a&ba=$b&cips=cinta");
  }

}

function ambil_data() {
  $url="http://localhost/KP/Final%20Testing/Final/Version6/uptodate/final01.php";
  $ch = curl_init();
